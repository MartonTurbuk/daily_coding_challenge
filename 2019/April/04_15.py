...
#
# Let's try using backtracking to solve this problem instead. What we can do is try filling each empty cell one by
# one, and backtrack once we hit an invalid state.
#
