...
# Strictly 'R's: array[:low] Strictly 'G's: array[low:mid] Unknown: array[mid:high] Strictly 'B's: array[high:] We'll
# initialize low and mid both to 0, and high to len(array) - 1 so that our unknown section is the whole array,
